...
with open('xGBoos_results.csv', 'w') as outfile:
    outfile.write('subsample,n_estimators,max_depth,learning_rate,colsample_bytree,colsample_bylevel,roc_auc, F1,recall,precision')
    outfile.write("\n")
